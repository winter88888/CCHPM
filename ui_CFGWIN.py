...
class Ui_CFGWIN(object):
    def setupUi(self, CFGWIN):
        ...
        self.spinBox_13.setGeometry(QtCore.QRect(650, 30, 51, 22))
        ...
        self.spinBox_14.setGeometry(QtCore.QRect(650, 70, 51, 22))
        ...
        self.checkBox.setGeometry(QtCore.QRect(20, 180, 231, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
    ...
    def retranslateUi(self, CFGWIN):
        ...
        CFGWIN.setWindowTitle(_translate("CFGWIN", "CCHPM v2.17 -Chain CH Performance Monitor"))
        ...
        self.label_33.setText(_translate("CFGWIN", "Lazy Aggro timer(min)"))
